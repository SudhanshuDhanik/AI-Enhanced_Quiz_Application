...
public class QuestionController {
    ...
    public ResponseEntity<Optional<Question>> getQuestionById(@PathVariable Long id) throws ChangeSetPersister.NotFoundException {
        Optional<Optional<Question>> theQuestion = Optional.ofNullable(questionService.getQuestionById(id));
