    ...
    const callGroqApi = async (message) => {
      try {
        ...
        const res = await client.responses.create({
          ...
          input: `Answer in 2 lines only: ${message}`,
        });

      const groqReply = res.output_text || "Sorry, I couldn't understand.";
      setResponse(groqReply);
      speak(groqReply);
    } catch (error) {
      const fallback = "Sorry, I'm having trouble connecting to Groq.";
